...
print("meters:",round(a.meters(),2))        
print("inches:",round(a.inches(),2))        
print("feet:",round(a.feet(),2))          
print("miles:",round(a.miles(),4))         
print("centimeter:",round(a.centimeters(),2))   
print("millimeter:",round(a.millimeters(),2))
print("kilometers:",round(a.kilometers(),4))